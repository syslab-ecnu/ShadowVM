...
pair<ObjectInfo, Object*> query_date_Q41() {
	auto date = load_date();
...
pair<ObjectInfo, Object*> query_part_Q41() {
	auto part = load_part();
	//part.second->Print();
...
pair<ObjectInfo, Object*> query_supplier_Q41() {
...
pair<ObjectInfo, Object*> query_customer_Q41() {
...
void test_SSB_Q41(bool isGPU) {
	...
	auto date = query_date_Q41();   date.second->Print();
   auto part = query_part_Q41();    part.second->Print();
	auto supplier = query_supplier_Q41();  supplier.second->Print();
	auto customer = query_customer_Q41();  customer.second->Print();
	//return;
	...
	PipelineTest query("test_SSB_Q41");
