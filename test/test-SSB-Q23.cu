...
pair<ObjectInfo, Object*> query_date_Q23() {
	auto date = load_date();
...
pair<ObjectInfo, Object*> query_part_Q23() {
	auto part = load_part();
	//part.second->Print();
...
pair<ObjectInfo, Object*> query_supplier_Q23() {
...
void test_SSB_Q23(bool isGPU) {
	...
	auto date = query_date_Q23();  // date.second->Print();
	auto part = query_part_Q23();  //  part.second->Print();
	auto supplier = query_supplier_Q23(); // supplier.second->Print();
	...
	ValType::Int32, ValType::Int32, ValType::Int32},
		{ 4, 4, 4, 4, 4, 4, 4, 4, 4});
	PipelineTest query("test_SSB_Q23");
