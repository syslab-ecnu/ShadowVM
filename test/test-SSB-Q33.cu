...
pair<ObjectInfo, Object*> query_date_Q33() {
	auto date = load_date();
...
pair<ObjectInfo, Object*> query_part_Q33() {
	auto part = load_part();
	//part.second->Print();
...
pair<ObjectInfo, Object*> query_supplier_Q33() {
...
pair<ObjectInfo, Object*> query_customer_Q33() {
...
void test_SSB_Q33(bool isGPU) {
	...
	auto date = query_date_Q33();  // date.second->Print();
//	auto part = query_part_Q31();  //  part.second->Print();
	auto supplier = query_supplier_Q33(); // supplier.second->Print();
	auto customer = query_customer_Q33(); // customer.second->Print();
	//return;
	...
	PipelineTest query("test_SSB_Q33");
